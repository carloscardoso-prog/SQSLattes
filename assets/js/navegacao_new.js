...
function montarNavegacao(holder,holderAtual) {
	...
	if (this.contentHolders.length > 1) {
		...
		this.scrollerDiv.parentNode.style.width = "100%";
...
function resizeNavegacao() {
	...
	if (frameHeight <= 0) {
		$(navegacao.fieldset).height(413);
		$(navegacao.areaSelecao).height(385);
		$(navegacao.fieldset).css("border","0px");
	}
...
function iniciarNavegacao() {
  ...
  var container = $("div.navegacao");
  
  <!--alert(container.size());-->

	$("div.navegacao").each(function(i){
